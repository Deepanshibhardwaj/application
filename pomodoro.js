...
var currentPhase = 'work'; // current phase: 'work', 'break'
var cycleCount = 0;
...
// Function to switch between work and break phases
function switchPhase() {
  if (currentPhase === 'work') {
    if (cycleCount > 0 && cycleCount % 4 === 0) { // Every 4 Pomodoros, take a long break (now removed)
      // No long break functionality
